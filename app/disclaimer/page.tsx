  ...
  return (
    <div className="max-w-sm mx-auto px-6 py-10 flex flex-col min-h-screen">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-black text-white mb-2">Before we begin</h1>
      ...
      {/* Disclaimer card */}
      <div className="bg-brand-purple-light rounded-3xl p-6 mb-6 flex flex-col gap-5">

        <div className="flex gap-4">
          <span className="text-2xl">📚</span>
          <div>
            <p className="text-white font-bold text-sm mb-1">This is education, not advice</p>
        ...
        <div className="flex gap-4">
          ...
          <div>
            <p className="text-white font-bold text-sm mb-1">Trading involves real risk</p>
            <p className="text-brand-lavender text-sm leading-relaxed">
        ...
        <div className="flex gap-4">
          <span className="text-2xl">💛</span>
          <div>
            <p className="text-white font-bold text-sm mb-1">We're in your corner</p>
            <p className="text-brand-lavender text-sm leading-relaxed">
      ...
      <button
        ...
        className="w-full bg-brand-yellow text-brand-purple font-black text-lg py-4 rounded-2xl shadow-lg active:scale-95 transition-transform mt-auto"
      >
